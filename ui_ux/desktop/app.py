...
from ui_ux.desktop.pages.whitelist_page import WhitelistPage
from ui_ux.desktop.pages.stats_page import StatsPage
...
class FocusEyePro(ctk.CTk):
    ...
    def __init__(self):
        ...
        self.whitelist_page = WhitelistPage(self)
    ...
    def _create_pages(self):
        ...
        self.pages["whitelist"] = self.whitelist_page.create()
        self.pages["stats"] = self.stats_page.create()
